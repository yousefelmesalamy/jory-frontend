...
/**
 * A social account. `label` is the untranslated brand name — it doubles as the
 * link's accessible name, since "Instagram" needs no localising and reads
 * correctly in both directions. `path` is the icon glyph (simple-icons, 24px).
 */
...
export class Footer {
  ...
  /** TODO: swap the handles for the roastery's real accounts once they exist. */
  readonly socials: readonly SocialLink[] = [
    {
      label: 'Instagram',
      href: 'https://www.instagram.com/jouriroastery',
